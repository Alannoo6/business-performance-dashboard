...
- **Marked seasonality in cash inflows:** monthly collections peak in May ($203M) and bottom out in February ($44M), a ~4.6x swing that must be anticipated in working-capital planning.
...
### Inventory Control
- **Inventory days of 143 (turnover 2.25x annual):** stock represents approximately 5 months of sales, well above the 30-60 day reference for retail. Material overstock and working capital tied up.
...
- Power Query transformations: `powerquery/`
